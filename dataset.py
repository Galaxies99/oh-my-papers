...
def get_gcn_dataset(file_path, seq_len=50, year=2016, frequency=5):
    '''
    Get dataset for gcn
...
if __name__ == '__main__':
    train_df, test_df = split_process_dataset(file_path='data/citation.csv', seq_len=50, year=2016, frequency=5)
    train_dataset = PapersDataset(train_df)
